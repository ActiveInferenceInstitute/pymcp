"""
Extension module to add visualization methods to PyMDPInterface.
"""
...
def _add_visualization_methods():
    ...
    # Add methods to PyMDPInterface class
    if not hasattr(PyMDPInterface, "plot_belief_dynamics"):
        PyMDPInterface.plot_belief_dynamics = plot_belief_dynamics
    
    if not hasattr(PyMDPInterface, "analyze_free_energy"):
        PyMDPInterface.analyze_free_energy = analyze_free_energy

# Add visualization methods when imported
